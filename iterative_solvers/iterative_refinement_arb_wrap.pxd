...
cpdef iterative_refinement_arb_wrap(Block_Factored_Mat A, Acb_Mat b, int prec, RealBall tol, PLU_Mat PLU, x0=*, maxiter=*, mix_prec=*, starting_prec=*, is_scaled=*, imposed_zeros=*)