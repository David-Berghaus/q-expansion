...
def test_belyi_map():
    ...
    assert (CF(-204788.266511846997417732376120597452504942099776674366809059697369771255508569807611107026928336726,-354856.283075376626293839386472132772905098041315141845293562059967286426080264752766926391137344234)-tmp_approx.get_cusp_expansion(Cusp(2,1))[9]).abs() < CF(10)**(-45)
